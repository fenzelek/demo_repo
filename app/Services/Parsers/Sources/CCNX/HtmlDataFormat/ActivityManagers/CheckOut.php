...
class CheckOut extends \App\Services\Parsers\Sources\CCNX\HtmlDataFormat\ActivityManagers\ActivityManager implements ActivityManager
{
    protected function getType()
    {
        return ActivityType::CHECK_OUT;
    }
